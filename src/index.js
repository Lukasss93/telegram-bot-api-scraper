...
async function run() {
    ...
    fs.writeFileSync(__dirname + '/../build/objects.json', JSON.stringify(data['object'], null, 2));

    //write methods to json file
    fs.writeFileSync(__dirname + '/../build/methods.json', JSON.stringify(data['method'], null, 2));
